...
def model_fn_builder(
    ...
    def model_fn(features, labels, mode, params):
        ...
        teacher_targets = tf.compat.v1.nn.softmax(logits / distill_temperature)
        ...
        total_loss = phase_loss / tf.compat.v1.reduce_sum(weights)

        tvars = [
            v for v in tf.compat.v1.trainable_variables() if 'student/' not in v.name
        ]
